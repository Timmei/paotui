...
@synthesize logoImage,Title,state;
...
//        image.backgroundColor = [UIColor blackColor];
        ...
        UILabel *_title = [[UILabel alloc]initWithFrame:CGRectMake(100, 10, 200, 40)];
        _title.backgroundColor = [UIColor clearColor];
        _title.text = @"全家便利店";
        self.Title = _title;
        [self addSubview:_title];
        
        UILabel *_lltitle = [[UILabel alloc]initWithFrame:CGRectMake(100, 50, 200, 40)];
